...
(function () {
    ...
    let scan_level = document.querySelector('#scan_level');
    let prec_mz = document.querySelector('#prec_mz');
    let prec_charge = document.querySelector('#prec_charge');
    let prec_inte = document.querySelector('#prec_inte');

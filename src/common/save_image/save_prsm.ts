class SavePrsm{
  ...
  initPrsmModalEventHandler = () => {
    ...
    d3.select('#save_prsm_btn').on("click", () => {
      ...
      (<HTMLInputElement>document.getElementById("letter-width")).value = para.getLetterWidth().toString();
      (<HTMLInputElement>document.getElementById("row-height")).value = para.getRowHeight().toString();
      (<HTMLInputElement>document.getElementById("block-width")).value = para.getGapWidth().toString();
      (<HTMLInputElement>document.getElementById("num-width")).value = para.getNumericalWidth().toString();
      (<HTMLInputElement>document.getElementsByName("show-num")[0]).checked = para.getShowNum();
      (<HTMLInputElement>document.getElementsByName("show-skipped-lines")[0]).checked = para.getShowSkippedLines();
    ...
    d3.select('#prsm_graph_redraw_btn').on("click", () => {
      ...
      para.setRowLength(parseInt((<HTMLInputElement>document.getElementById("row-size")).value));
      para.setLetterWidth(parseInt((<HTMLInputElement>document.getElementById("letter-width")).value));
      para.setRowHeight(parseInt((<HTMLInputElement>document.getElementById("row-height")).value));
      para.setGapWidth(parseInt((<HTMLInputElement>document.getElementById("block-width")).value));
      para.setNumericalWidth(parseInt((<HTMLInputElement>document.getElementById("num-width")).value));

      //	Check whether show numbers is checked
      if((<HTMLInputElement>document.getElementsByName("show-num")[0]).checked) {
      ...
      if((<HTMLInputElement>document.getElementsByName("show-skipped-lines")[0]).checked) {
    ...
    d3.select('#prsm_popup_svg_btn').on("click",(event: any) => {
    ...
    d3.select('#prsm_popup_png_btn').on("click", (event: any) => {
      let svgId = "prsm_popup_svg" ;
      let x = event.pageX;
      let y = event.pageY;

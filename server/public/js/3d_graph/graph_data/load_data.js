...
LoadData.calculateTableNum = async () => {
...
LoadData.load3dData = (curViewRange) => {
    ...
    return new Promise(async (resolve, reject) => {
        ...
        let inteCutoff = inteCutOffBox.value;
        if (inteCutoff == '') {
            inteCutoff = '0';
        }

...
(function (factory) {
    ...
    $.extend(altEditor.prototype, {
        ...
        _editRowData: function () {
            ...
            that.onEditRow(that, rowDataArray, function (data, b, c, d, e) {
        ...
        _deleteRow: function () {
            ...
            that.onDeleteRow(that, jsonDataArray, 
            //function(data){ that._deleteRowCallback(data); refresh();},
            function (data) { that._deleteRowCallback(data); }, function (data) {
                that._errorCallback(data);
            });
        },
        /**
        ...
        _openAddModal: function () {
            ...
            var data = this.createDialog(columnDefs, this.language.add.title, this.language.add.button, this.language.modalClose, 'addRowBtn', 'altEditor-add-form');
            var selector = this.modal_selector;
        ...
        */
        ...
        _addRowData: function () {
            ...
            // console.log(rowDataArray); //DEBUG
            that.onAddRow(that, rowDataArray, function (data) { that._addRowCallback(data); }, function (data) {
                that._errorCallback(data);

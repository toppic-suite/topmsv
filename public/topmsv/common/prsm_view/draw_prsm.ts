...
class DrawPrsm {
  ...
  drawPrsm(svgId: string, para: PrsmPara, data: PrsmViewData, addShift: AddShift | null): void {
  ...
  initSvg(svg: any, para: PrsmPara, data: PrsmViewData): void {
 ...
 */
  addStartSkippedLine(svg: any, para: PrsmPara, data: PrsmViewData): void {
 ...
 * @param {Object} info - Contains the skipped information. 
 */
  addEndSkippedLine(svg: any, para: PrsmPara, data: PrsmViewData): void {
 ...
 */
  addAminoAcids(svg: any, para: PrsmPara, data:PrsmViewData, addShift: AddShift): void {
 ...
 * @param {String} seq - Contains the protein sequence
 */
  addAminoAcidsNoMods(svg: any, para: PrsmPara, data:PrsmViewData): void {
    let residues: Residue[] = data.getResidues(); 
    let start: number = data.getDisplayFirstPos();
    let end: number = data.getDisplayLastPos();
    let isStartSkipped: boolean = data.getShowStartSkipped();
   ...
   */
  addPosNums (svg: any, para: PrsmPara, data: PrsmViewData): void {
    let startPos: number = data.getDisplayFirstPos();
   ...
   * @param {Object} para - Contains parameters of width, letter space etc., to draw SVG
   */
  drawStartSymbol(svg: any, para: PrsmPara, data: PrsmViewData): void {
  ...
  drawEndSymbol(svg: any, para: PrsmPara, data: PrsmViewData) {
    let dispFirstPos: number = data.getDisplayFirstPos();
   ...
   */
    drawBreakPoints(svg: any, para: PrsmPara, data:PrsmViewData): void {
    let dispFirstPos: number = data.getDisplayFirstPos();
    let formFirstPos: number = data.getFormFirstPos();
  ...
  */
  appendBpAnno(event: any, anno: string): void {
 ...
 */
  addAnnos(svg: any, para: PrsmPara, data: PrsmViewData): void {
 ...
 * @param {Object} para - Contains parameters of width, letter space etc., to draw SVG
 */
  addAnnoBackground(svg: any, para: PrsmPara, data: PrsmViewData) {
    let firstPos: number = data.getDisplayFirstPos();
    let annos: Annotation[] = data.getAnnotations(); 
    let isStartSkipped: boolean = data.getShowStartSkipped();

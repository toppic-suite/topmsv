...
const drawNav = function () {
  ...
  <li class="navtab">|</li><li class="nav-item"><a class="nav-link" href="' + relPath + '../spectra.html">Raw Spectra</a></li>\
  <li class="navtab">|</li><li class="nav-item"><a class="nav-link" href="' + relPath + '../../">Home</a></li></ul>\
  </div></div></div></nav>';
    $(function () {

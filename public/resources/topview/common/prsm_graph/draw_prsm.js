"use strict";
function drawPrsm(svgId, para, data) {
...
function initSvg(svg, para, data) {
 ...
 */
function addStartSkippedLine(svg, para, data) {
 ...
 * @param {Object} info - Contains the skipped information.
 */
function addEndSkippedLine(svg, para, data) {
 ...
 */
function addAminoAcids(svg, para, data) {
 ...
 */
function addPosNums(svg, para, data) {
    let startPos = data.getDisplayFirstPos();
 ...
 * @param {Object} para - Contains parameters of width, letter space etc., to draw SVG
 */
function drawStartSymbol(svg, para, data) {
...
function drawEndSymbol(svg, para, data) {
    let dispFirstPos = data.getDisplayFirstPos();
 ...
 */
function drawBreakPoints(svg, para, data) {
    let dispFirstPos = data.getDisplayFirstPos();
    let formFirstPos = data.getFormFirstPos();
 ...
 */
function addAnnos(svg, para, data) {
 ...
 * @param {Object} para - Contains parameters of width, letter space etc., to draw SVG
 */
function addAnnoBackground(svg, para, data) {
    let firstPos = data.getDisplayFirstPos();
    let annos = data.getAnnotations();
    let isStartSkipped = data.getShowStartSkipped();
    ...
    for (let i = 0; i < annos.length; i++) {
        ...
        for (let j = startRow; j <= endRow; j++) {
            ...
            bgGroup.append("rect")
                ...
                .style("fill", para.getMassShiftColor())

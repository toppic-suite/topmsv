...
help_win = document.getElementById('helpPopupWin');
help_win_close_btn = document.getElementById('helpPopupWinCloseBtn');
ms_file_path_text = document.getElementById('msFilePathText')
ms_one_total_scan_num_text = document.getElementById('msOneTotalScanNumText')
cur_ms_one_order_text = document.getElementById('curMsOneOrderText')
cur_ms_one_scan_text = document.getElementById('curMsOneScanText')
cur_ms_one_peak_num_text = document.getElementById('curMsOnePeakNumText')
cur_ms_one_env_num_text = document.getElementById('curMsOneEnvNumText')
cur_ms_one_rt_text = document.getElementById('curMsOneRTText')

query_ms_one_scan_input = document.getElementById('queryMsOneScanInput')
...
ms_two_total_scan_num_text = document.getElementById('msTwoTotalScanNumText')
cur_ms_two_order_text = document.getElementById('curMsTwoOrderText')
cur_ms_two_scan_text = document.getElementById('curMsTwoScanText')
cur_ms_two_peak_num_text = document.getElementById('curMsTwoPeakNumText')
cur_ms_two_env_num_text = document.getElementById('curMsTwoEnvNumText')
cur_ms_two_prec_mz_text = document.getElementById('curMsTwoPrecMzText')
cur_ms_two_rt_text = document.getElementById('curMsTwoRTText')
query_ms_two_scan_input = document.getElementById('queryMsTwoScanInput')

spec_data = new SpectrumData();
...
async function updateMsOneById(cur_ms_one_id) {
  if (cur_ms_one_id >= 0 && cur_ms_one_id < spec_data.getMsOneScanNum()) {
    ...
    db_peak_list = await window.electronAPI.getMsOnePeakListById(cur_ms_one_id); 
    ...
    db_env_list = await window.electronAPI.getMsOneEnvListById(cur_ms_one_id); 
    ...
    db_env_peak_list = await window.electronAPI.getMsOneEnvPeakListById(cur_ms_one_id);

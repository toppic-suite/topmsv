...
public:
	...
	void updateColor(int current_id, std::string color);
	...
	void insertPeakStmtMs1Temp(int peak_index, double intensity, double mz, double retention_time, std::string color);
	void createIndex();
